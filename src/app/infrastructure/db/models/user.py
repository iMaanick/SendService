from sqlalchemy import BigInteger, Boolean, Enum, LargeBinary, String, Table, Column
...
users_table = Table(
    ...
    Column("role", Enum(UserRole, name="userrole"), nullable=False, default=UserRole.USER),
